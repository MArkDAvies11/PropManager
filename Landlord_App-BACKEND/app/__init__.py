...
def create_app(config_class=None):
    ...
    try:
        # Maintenance routes
        from app.resources.maintenance import MaintenanceRequestList, MaintenanceRequestDetail
        api.add_resource(MaintenanceRequestList, '/api/maintenance')
        api.add_resource(MaintenanceRequestDetail, '/api/maintenance/<int:request_id>')
        app.logger.info("Maintenance routes registered")
        
    except Exception as e:
        app.logger.error(f"Failed to register maintenance routes: {e}")
